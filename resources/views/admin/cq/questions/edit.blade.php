                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <textarea class="form-control @error('sub_question_a') is-invalid @enderror" 
                                                  id="sub_question_a" name="sub_question_a" rows="2" required>{{ old('sub_question_a', $question->sub_question_a) }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <textarea class="form-control @error('sub_question_b') is-invalid @enderror" 
                                                  id="sub_question_b" name="sub_question_b" rows="2" required>{{ old('sub_question_b', $question->sub_question_b) }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <textarea class="form-control @error('sub_question_c') is-invalid @enderror" 
                                                  id="sub_question_c" name="sub_question_c" rows="2" required>{{ old('sub_question_c', $question->sub_question_c) }}</textarea>
                                ...
                                <div class="row">
                                    <div class="col-md-10">
                                        ...
                                        <textarea class="form-control @error('sub_question_d') is-invalid @enderror" 
                                                  id="sub_question_d" name="sub_question_d" rows="2">{{ old('sub_question_d', $question->sub_question_d) }}</textarea>
